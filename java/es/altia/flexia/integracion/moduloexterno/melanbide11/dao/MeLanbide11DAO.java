...
public class MeLanbide11DAO {
    ...
    public List<ContratacionVO> getContratacion(String numExp, Connection con) throws Exception {
        ...
        try {
            ...
            query = "Select * From "
                    + ConfigurationParameter.getParameter(ConstantesMeLanbide11.MELANBIDE11_CONTRATACION,
                            ConstantesMeLanbide11.FICHERO_PROPIEDADES)
                    + " A Where A.Num_Exp= ? Order By A.Id";
            if (log.isDebugEnabled()) {
    ...
    /**
     * Obtiene solo el DNI (DNICONT) de una contrataci�n concreta por ID y n�mero de
     * expediente. Evita cargar la lista completa de contrataciones cuando
     * �nicamente se necesita resolver el filtro para la tabla de desglose RSB.
     * 
    ...
    public String getDniContratacionById(String numExp, String idContrato, Connection con) throws Exception {
        ...
        try {
            ...
            log.error("Error obteniendo DNI por ID de contrataci�n", e);
    ...
    public ContratacionVO getContratacionPorID(String id, Connection con) throws Exception {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                // Solo guardamos en VO los salariales (requerimiento pesta�a 1)
                contratacion.setRsbImporte(complementosSalariales);

                if (log.isDebugEnabled()) {
                    log.debug("*** CARGA COMPLEMENTOS SALARIALES (CORRELACIONADA) ***");
                    log.debug("ID Contrataci�n: " + contratacion.getId());
    ...
    public boolean crearNuevaContratacion(ContratacionVO nuevaContratacion, Connection con) throws Exception {
        ...
        try {
            if (log.isDebugEnabled())
                log.debug("FLUJO RSB - Paso 6: Calculando RSB total para inserci�n");
            ...
            // El importe de subvenci�n es independiente del c�lculo RSB
            ...
            log.debug("Error al insertar una nueva Contrataci�n: " + ex.getMessage());
            throw new Exception(ex);
        } finally {
            if (st != null)
                st.close();
    ...
    // === modificarContratacion (reemplaza tu m�todo por este) ===
    public boolean modificarContratacion(ContratacionVO datModif, Connection con) throws Exception {
        ...
        try {
            if (log.isDebugEnabled())
                log.debug("FLUJO RSB - Paso 6: Calculando RSB total para actualizaci�n");
    ...
    /**
     * Recupera las l�neas de desglose RSB filtradas por expediente y DNI del
     * contratado. Si no existen resultados devuelve lista vac�a.
     */
    public List<DesgloseRSBVO> getDatosDesgloseRSBPorDni(String numExp, String dni, int codOrganizacion, Connection con)
        ...
        try {
            String query = "SELECT * FROM "
                    + ConfigurationParameter.getParameter(ConstantesMeLanbide11.MELANBIDE11_DESGRSB,
                            ConstantesMeLanbide11.FICHERO_PROPIEDADES)
                    + " WHERE NUM_EXP = ? AND DNICONTRSB = ? ORDER BY ID";
            if (log.isDebugEnabled()) {
     ...
     * usa para persistir los valores de la pesta�a 1 (salario base, pagas extra y
     ...
     * @return true si se actualiz� alguna fila
     */
    ...
    /** Nueva versi�n con RSBTIPO y RSBIMPORTE */
    public boolean actualizarDesgloseBasico(String idRegistro, Double salarioBase, Double pagasExtra,
     ...
     * para un DNI espec�fico en un expediente
     * 
     * @param numExp N�mero de expediente
     ...
     * bas�ndose en el campo RSBTIPO de la tabla MELANBIDE11_DESGRSB
     * 
     * @param numExp N�mero de expediente
     * @param dni    DNI del contratado
    ...
    /**
     * Actualiza autom�ticamente el campo RSBCOMPCONV calculando la suma de:
     * RSBSALBASE + RSBPAGEXTRA + suma de RSBIMPORTE de MELANBIDE11_DESGRSB Solo
     * actualiza si el c�lculo es diferente al valor actual
     */
    public boolean actualizarRsbCompConv(String numExp, String dni, Connection con) throws Exception {
        ...
        try {
            ...
            // Consulta que actualiza RSBCOMPCONV con la suma calculada (usando PreparedStatement)
            ...
            if (log.isDebugEnabled()) {
                log.debug("*** QUERY ACTUALIZACION RSBCOMPCONV (PreparedStatement) ***");
            ...
            log.error("Error al actualizar RSBCOMPCONV autom�ticamente", ex);
            throw new Exception(ex);
        } finally {
            if (ps != null) {
                ps.close();
     ...
     * depender de una secuencia que no est� definida en constantes).
     */
    ...
    /**
     * Reemplaza (borrando e insertando) las l�neas de desglose RSB para un
     * expediente + DNI. Despu�s recalcula RSBCOMPCONV en la tabla principal.
     *
     * @param numExp N�mero de expediente
     * @param dni    DNI contratado
     * @param lineas Lista de l�neas (puede ser vac�a o null -&gt; implica borrar
     *               todo)
     * @param con    Conexi�n
     * @return true si la operaci�n global finaliza sin errores
     * @throws Exception
     */
    ...
    /**
     * Obtiene todas las contrataciones de un expediente espec�fico.
     */
    public List<ContratacionVO> getContratacionesByExpediente(String numExpediente, Connection con) throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // Conversi�n segura de edad String a Integer
                ...
                // Conversi�n segura de PORC_JORNADA String a Double
                ...
                // Conversi�n segura de HORAS_CONV String a Integer
                ...
                // Conversi�n segura de COSTE_CONTRATO String a Double
    ...
    /**
     * Obtiene una contrataci�n espec�fica por su ID.
     */
    public ContratacionVO getContratacionById(String id, Connection con) throws Exception {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                // Conversi�n segura de edad String a Integer (m�todo getContratacionById)
                ...
                log.debug("getContratacionById - Contrataci�n encontrada");
                return contratacion;
            } else {
                log.debug("getContratacionById - Contrataci�n no encontrada");
                return null;
            }
    ...
    /**
     * Elimina una contrataci�n por ID
     * 
     * @param id  ID de la contrataci�n
     * @param con Conexi�n a la base de datos
    ...
    public boolean eliminarContratacionAJAX(String id, Connection con) throws Exception {
        ...
        try {
            ...
            if (deleted) {
                log.debug("eliminarContratacionAJAX - Contrataci�n eliminada: " + id);
            } else {
                log.debug("eliminarContratacionAJAX - No se encontr� contrataci�n con ID: " + id);
            }

            return deleted;
        } catch (SQLException e) {
            log.error("Error SQL en eliminarContratacionAJAX", e);
            throw new Exception("Error al eliminar contrataci�n: " + e.getMessage());
        } finally {
            if (ps != null)
                ps.close();
        }
